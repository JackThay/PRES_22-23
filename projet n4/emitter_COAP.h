...
class Emitter_COAP : public cSimpleModule  // define a new class called "Emitter" that inherits from the OMNeT++ class "cSimpleModule"
{
    private:
    ...
    public:
        Emitter_COAP();  // default constructor for the Emitter class
        virtual ~Emitter_COAP();  // virtual destructor for the Emitter class
